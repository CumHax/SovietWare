...
public class Discord {
    ...
    public static void startRPC() {
        ...
        discordRichPresence.details = Minecraft.getMinecraft().getSession().getUsername() + " < he's praying allah";
        discordRichPresence.largeImageKey = "mm";
        discordRichPresence.largeImageText = "ballin";
