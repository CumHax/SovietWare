...
{
	private final Setting mode = new Setting("Mode", this, Arrays.asList("Normal", "Dispenser"));
	...
	{
		if ((Keyboard.getEventKey() == Keyboard.KEY_ESCAPE || Keyboard.getEventKey() == mc.gameSettings.keyBindInventory.getKeyCode()) && disable.getBoolValue())
		{
			disable();
		}
	}
...
/*	@SubscribeEvent
	public void onLivingDeath(LivingDeathEvent event)
	{
		...
		if (targetedPlayers.containsKey(name) && disable.getBoolValue()) disable();
	}*/

	@SubscribeEvent
	public void onPacketSend(PacketEvent.Send event)
	{
		if (event.getPacket() instanceof CPacketCloseWindow && noClose.getBoolValue())
		{
