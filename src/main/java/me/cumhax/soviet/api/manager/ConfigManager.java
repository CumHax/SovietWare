package me.cumhax.soviet.api.manager;

import me.cumhax.soviet.Client;
import me.cumhax.soviet.api.module.Module;
import me.cumhax.soviet.api.setting.Setting;
import me.cumhax.soviet.api.util.FileUtil;
import me.cumhax.soviet.api.util.FriendUtil;
...
public class ConfigManager extends Thread
{
    ...
    private static final File mainFolder = new File(mc.gameDir + File.separator + "SovietWare");
